...
<body>
        ...
        <div class="profile-content">
            ...
            <div class="profile-sidebar">
                <div class="sidebar-section">
                    ...
                    <a href="recipes.php?user=<?php echo $profileUserId; ?>" class="btn btn-outline btn-sm">View All Recipes</a>
                    <?php else: ?>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        const imageCloseBtn = document.querySelector('.image-close-btn');        document.querySelectorAll('.post-card-media img').forEach(img => {
